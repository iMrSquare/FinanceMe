...
function BackToResumen() {
  return (
    <Link href="/hogar" className="text-sm font-semibold" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 8, whiteSpace: 'nowrap', color: 'var(--text-secondary)' }}>
