...
import type { PersonalGastoFijo, PersonalSuscripcion, PersonalAhorro } from '@/lib/db';
          ...
          <div className="sm:flex sm:items-start sm:justify-between sm:mb-4">
            <div>
              ...
              <p className="text-sm sm:text-3xl font-extrabold leading-tight" style={{ color: loading ? 'var(--text-muted)' : '#ef4444' }}>
                {loading ? '—' : fmt(totalGastos)}
              </p>
              <p className="hidden sm:block text-xs mt-1" style={{ color: 'var(--text-muted)' }}>{gastos.length} conceptos</p>
            </div>
        ...
        <Link href="/personal/ahorro" className="glass-card rounded-2xl sm:rounded-3xl p-3 sm:p-6 block transition-transform hover:-translate-y-0.5">
          <div className="sm:flex sm:items-start sm:justify-between sm:mb-4">
            <div>
              ...
              <p className="text-sm sm:text-3xl font-extrabold leading-tight" style={{ color: loading ? 'var(--text-muted)' : '#10b981' }}>
            ...
            <div className="hidden sm:flex w-11 h-11 rounded-2xl items-center justify-center shrink-0" style={{ background: 'rgba(16,185,129,0.12)' }}>
          ...
          <p className="hidden sm:block text-xs font-semibold" style={{ color: '#10b981' }}>Ver ahorro →</p>
        </Link>
      </div>

      {/* Calendar + upcoming — on mobile: próximos first, then calendar */}
